...
namespace Tests\DomainBankSlipCore\Model\Specification;
...
class SpecificationTest extends BaseUnitTestCase
{
    ...
    public function testShouldSatisfyByBarCodeUnique()
    {
        ...
        $mockDocumentRepository = \Mockery::mock('DomainBankSlipCore\Infrastructure\Persistence\Repositories\DocumentRepositoryInMemory');
